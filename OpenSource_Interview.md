...
웹은 거의 대부분 오픈소스 소프트웨어로 개발이 됐는데, 어느 순간, 21세기에 들어오면서 웹 소프트웨어가 일반적인 소프트웨어의 대부분을 차지하는 시대가 됐잖아요. 그전에 데스크탑 소프트웨어 같은 경우는 헤게모니가 클로즈드 소프트웨어에 주로 있었지만, 웹은 그렇지 않으니까. 그렇기 때문에 헤게모니 자체가 건너간거에요. 웹에서 가장 많이 썼던 언어들. php나 뭐 java, 그 다음에 지금와서는 python이나 이런것들. 그 다음에 웹프레임워크들. 그런것도 다 오픈소스였기 때문에 그렇게 된거죠.
